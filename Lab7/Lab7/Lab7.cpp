...
void addMenu(BinomialHeap<Event>& heap)
{
	while (true)
	{
		std::string line = "0";
...
void removeMenu(BinomialHeap<Event>& heap)
{
	while (true)
	{
		std::string line = "0";
...
void addeventsToHeap(BinomialHeap<Event>& heap, std::string path)
{
